...
class OnePassDocumentInterpreter:
    ...
    def interpret(
        ...
        """Normalize, interpret, and deterministically validate one source."""
...
- Account for every page exactly once using a page coverage range and one of: interpreted, blank,
  irrelevant, unreadable, or unprocessed_review_required.
- Attach evidence only to interpreted pages. Evidence excerpt text is model-observed metadata, not
  independently verified source text, and must use excerpt_provenance=model_observed.
