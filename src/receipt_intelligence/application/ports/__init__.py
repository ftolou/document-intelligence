...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "GenerationFailureReason": ("llm", "GenerationFailureReason"),
    "GenerationIncompleteError": ("llm", "GenerationIncompleteError"),
    "GenerationProviderUnavailableError": ("llm", "GenerationProviderUnavailableError"),
    "GenerationRefusedError": ("llm", "GenerationRefusedError"),
    "GenerationResult": ("llm", "GenerationResult"),
    "GenerationValue": ("llm", "GenerationValue"),
    "LlmGateway": ("llm", "LlmGateway"),
    "MalformedGenerationError": ("llm", "MalformedGenerationError"),
