    ...
    def run_job(self, job_id: str, image_path: Path, options: dict[str, Any]) -> None:
        ...
        try:
            ...
            extraction_request = ExtractionRequest(
                ...
                vlm_command=options["vlm_command"],
    ...
    def _build_key_artifacts(
        ...
        *,
        ...
        artifacts = {
            ...
            "table_interpretation_raw": optional("table_interpretation_raw"),
            "region_reocr": optional("region_reocr"),
            "right_column_reocr": optional("right_column_reocr"),
            "correction_raw": optional("correction_raw"),
            "corrected_receipt": optional("receipt_llm_corrected"),
