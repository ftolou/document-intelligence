...
def test_legacy_spatial_alias_remains_current() -> None:
    ...
    assert resolve_extraction_strategy(
        environ={"RECEIPT_EXTRACTION_STRATEGY": "spatial-overview"}
...
def test_transcription_model_environment() -> None:
    ...
    assert resolve_transcription_model(
        environ={"QWEN_TRANSCRIPTION_MODEL": "qwen3.5:9b"}
    ) == "qwen3.5:9b"
