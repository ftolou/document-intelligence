#!/usr/bin/env python3
"""Flask transport for the standalone PaddleOCR-VL CLI service."""
...
from receipt_vlm_service.service import VlmService
...
def resolve_image_from_request(settings: VlmSettings) -> tuple[Path | None, str | None]:
...
def create_app(
    *,
    ...
    def analyze():
        ...
        return jsonify(service.execute(image_path=image_path, run_id=run_id))

    return flask_app


_settings = VlmSettings.from_environment()
